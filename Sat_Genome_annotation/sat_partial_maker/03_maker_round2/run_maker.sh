...
cd /home/eenbody/ruff/Genome_annotation/02_maker_ab_initio_partial_sat

module load bioinfo-tools maker/3.01.2-beta

export AUGUSTUS_CONFIG_PATH=/home/eenbody/ruff/Genome_annotation/01_maker_evi_based_partial_sat/train_augustus/augustus_config
