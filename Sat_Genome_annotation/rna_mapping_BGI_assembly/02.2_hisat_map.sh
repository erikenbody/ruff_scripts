...
WORK_D=/home/eenbody/ruff/Genome_annotation/rna_mapping/bgi_mapping
...
hisat2 -p 20 --dta -x Ruff_tran_BGI -1 $SAMPLEDIR/fixed_QL-1682-Ruff-skin2_S17_L002_R1_001.cor_val_1.fq.gz -2 $SAMPLEDIR/fixed_QL-1682-Ruff-skin2_S17_L002_R2_001.cor_val_2.fq.gz  -S ${SAMPLE}.sam
