...
#SBATCH -e preprocess_RNAseq_%A.err            # File to which STDERR will be written
#SBATCH -o preprocess_RNAseq_%A.out
...
trim_galore --paired --retain_unpaired --phred33 --output_dir . --fastqc --gzip --length 36 -q 5 --stringency 1 -e 0.1 $SAMPLEDIR/${SAMPLE}_1.fastq.gz $SAMPLEDIR/${SAMPLE}_2.fastq.gz
