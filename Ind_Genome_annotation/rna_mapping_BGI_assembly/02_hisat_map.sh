...
#SBATCH -t 24:00:00
#SBATCH -J hisat2
#SBATCH -e hisat2_%A.err            # File to which STDERR will be written
...
hisat2 -p 20 --dta -x Ruff_tran_BGI -1 $SAMPLEDIR/${SAMPLE}_1.cor_val_1.fq.gz -2 $SAMPLEDIR/${SAMPLE}_2.cor_val_2.fq.gz -S ${SAMPLE}.sam
